...
fun EmpleadoEditScreen(
    ...
    if (uiState.showDatePicker) {
        ...
        DatePickerDialog(
            onDismissRequest = { viewModel.onEvent(EmpleadoEditUIEvent.HideDatePicker) },
            confirmButton = {
                TextButton(onClick = {
                    datePickerState.selectedDateMillis?.let { millis ->
                        viewModel.onEvent(EmpleadoEditUIEvent.FechaIngresoChanged(millis))
                    }
                    viewModel.onEvent(EmpleadoEditUIEvent.HideDatePicker)
                }) { Text("Aceptar") }
            },
            dismissButton = {
                TextButton(onClick = { viewModel.onEvent(EmpleadoEditUIEvent.HideDatePicker) }) {
                    Text("Cancelar")
                }
            }
        ) {
            ...
            ElevatedCard(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.fillMaxWidth().padding(16.dp)) {
                    ...
                    OutlinedTextField(
                        ...
                        value = uiState.fechaIngreso?.let { dateFormatter.format(Date(it)) } ?: "",
                        onValueChange = {},
                        readOnly = true,
                        isError = uiState.fechaIngresoError != null,
                        trailingIcon = {
                            IconButton(onClick = { viewModel.onEvent(EmpleadoEditUIEvent.ShowDatePicker) }) {
                                Icon(Icons.Default.CalendarToday, contentDescription = "Seleccionar fecha")
                            }
                        },
                        modifier = Modifier.fillMaxWidth().clickable { viewModel.onEvent(EmpleadoEditUIEvent.ShowDatePicker) }
                    )
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = { viewModel.onEvent(EmpleadoEditUIEvent.NombresChanged(it)) },
                    ...
                    ExposedDropdownMenuBox(
                        ...
                        OutlinedTextField(
                            ...
                            trailingIcon = { Icon(Icons.Default.ArrowDropDown, contentDescription = "Seleccionar sexo") },
                        ...
                        ExposedDropdownMenu(
                            ...
                            sexoOptions.forEach { option ->
                                DropdownMenuItem(
                                    text = { Text(option) },
                                    onClick = {
                                        viewModel.onEvent(EmpleadoEditUIEvent.SexoChanged(option))
                                        sexoExpanded = false
                                    }
                                )
                            }
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = { viewModel.onEvent(EmpleadoEditUIEvent.SueldoChanged(it)) },
                    ...
                    Row(
                        ...
                        OutlinedButton(
                            onClick = { viewModel.onEvent(EmpleadoEditUIEvent.Save) },
                        ...
                        if (!uiState.isNew) {
                            OutlinedButton(
                                onClick = { viewModel.onEvent(EmpleadoEditUIEvent.Delete) },
